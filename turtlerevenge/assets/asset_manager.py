...
from turtlerevenge.assets.spritesheet import SpriteSheet
from turtlerevenge.assets.flipbook import FlipBook
...
class AssetManager:
    ...
    def __init__(self):
        if AssetManager._instance is None:
            ...
            raise exception("Asset Manager doesn't Allow Multiple Instances")
